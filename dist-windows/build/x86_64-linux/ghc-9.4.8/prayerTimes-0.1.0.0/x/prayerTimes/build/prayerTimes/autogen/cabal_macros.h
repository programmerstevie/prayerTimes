...
/* package prayerTimes-0.1.0.0 */
#ifndef VERSION_prayerTimes
#define VERSION_prayerTimes "0.1.0.0"
#endif /* VERSION_prayerTimes */
#ifndef MIN_VERSION_prayerTimes
#define MIN_VERSION_prayerTimes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_prayerTimes */
...
#define CURRENT_COMPONENT_ID "prayerTimes-0.1.0.0-inplace-prayerTimes"
